...
const HomeSidebar = ({ onNavigate }) => {
    ...
    const handleClick = (page) => {
        onNavigate(page);
        setIsOpen(false); // retract sidebar on click
    };
        ...
        <>
            ...
            <div className="hidden lg:flex flex-col justify-between w-60 h-full bg-base-100 shadow-xl p-4 fixed top-0 left-0">
                ...
                <button
                    ...
                    className="flex gap-2 items-center btn btn-ghost mt-4"
                >
            ...
            >
                ...
                <button
                    ...
                    className="flex gap-2 items-center btn btn-ghost mt-4"
                >
                    <MessageCircle size={20} /> All Guilds
                </button>
            </motion.div>
        </>
    );
